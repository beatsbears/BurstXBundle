...
if [ $1 = "1.3.6cg" ]; then
    ...
    echo "brs.dbUrl=jdbc:mariadb://localhost:3306/burstwallet_xb" >> ./burstcoin/burstcoin-$1/conf/brs.properties
    echo "brs.dbUsername=burst_user_xb" >> ./burstcoin/burstcoin-$1/conf/brs.properties
    echo "brs.dbPassword=MyV3ryL0ngBurstP@ssword1!" >> ./burstcoin/burstcoin-$1/conf/brs.properties
fi
